<!--
STAGING NOTE (remove this comment block before committing to the hub):
This file's body (below the ruled-off comment) is the exact, ratified content of
SADOT_DOMAIN_RULES_CANON_v1.0.0.md, approved IMPLEMENT-NOW by team_100 on 2026-07-10 — see the
companion TRIAGE_DOMAIN_PROTOCOL_PROPOSAL_SADOT_DOMAIN_RULES_2026-07-10_v1.0.0.md in this directory.
Source: _COMMUNICATION/team_100/DOMAIN_PROTOCOL_PROPOSAL_SADOT_DOMAIN_RULES_v1.0.0.md §2, approved
as drafted with no redline.

To execute (from a session rooted at /Users/nimrod/Documents/AOS_V5/agents-os):
1. Copy everything below the "=== HUB FILE CONTENT BELOW ===" line verbatim into
   lean-kit/modules/project-governance/SADOT_DOMAIN_RULES_CANON_v1.0.0.md
2. Commit, following the same commit pattern used for TT_DOMAIN_RULES_CANON_v1.0.0.md.
3. Run governance propagation (AOS_gov-sync / propagate_governance.sh) so it lands in Sadot's
   _aos/lean-kit/modules/project-governance/ cache.
4. Check off items 3–4 in DOMAIN_PROTOCOL_PROPOSAL_SADOT_DOMAIN_RULES_v1.0.0.md §6.
-->

=== HUB FILE CONTENT BELOW ===
